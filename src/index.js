document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    question.choices.forEach((choice) => {
      ...
      choiceContainer.appendChild(newListItem);
    });
  ...
  function nextButtonHandler() {
    ...
    const choiceElements = document.querySelectorAll("li input");
  ...
  const restartBtnId = document.getElementById("restartButton");
  restartBtnId.addEventListener("click", () => {
    showQuestion();
    location.reload();
  });
});
